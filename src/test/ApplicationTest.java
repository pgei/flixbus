...
public class ApplicationTest {
    ...
    void initializeRepositories() {
        ...
        Bus bus0 = new Bus(0,location0, location1, 2024, 12, 12, 12, 0, 14, 0, 2);
        Bus bus1 = new Bus(1,location0, location2, 2024, 12, 25, 13, 0, 16, 45, 2);
        Train train2 = new Train(2,location0, location2, 2025, 1, 1, 13, 0, 16, 45, 1, 10);
        ...
        BusTicket ticket0 = new BusTicket(0, costumer, bus1, 20, 2);
        BusTicket ticket1 = new BusTicket(1, costumer, bus1, 20, 1);
        TrainTicket ticket2 = new TrainTicket(2, costumer1, train2, 15, 210, 2);
